...
st.warning("Falta agregar diseño :(")
...
with st.form("my_form"):
    ...
    if(res_est0):
        res_est0 = "".join(sorted(res_est0)) 

    #Pregunta 2
    st.write(preguntas[1])
    res_est1 = st.text_input("2. Ingresa tu respuesta:")
    if(res_est1):
        res_est1 = "".join(sorted(res_est1)) 

    #Pregunta 3
    st.write(preguntas[2])
    res_est2 = st.text_input("3. Ingresa tu respuesta:")
    if(res_est2):
        res_est2 = "".join(sorted(res_est2)) 
    
    #Pregunta 4
    st.write(preguntas[3])
    res_est3 = st.text_input("4. Ingresa tu respuesta:")
    if(res_est3):
        res_est3 = "".join(sorted(res_est3)) 

    #Pregunta 5
    st.write(preguntas[4])
    res_est4 = st.text_input("5. Ingresa tu respuesta:")
    if(res_est4):
        res_est4 = "".join(sorted(res_est4)) 
